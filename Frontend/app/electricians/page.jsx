    ...
    <>
      ...
      <header className="bg-cover bg-center h-64 flex items-center justify-center"
        ...
        <div className="bg-black bg-opacity-60 text-white p-8 rounded">
          <h1 className="text-4xl font-bold">Electricians</h1>
        </div>
      </header>

      <section className="py-16 px-6 md:px-20 bg-white">
        <h2 className="text-2xl font-semibold mb-4 text-center text-gray-800">
          Expert electricians for Your Home and Office
        </h2>
        <p className="text-center max-w-2xl mx-auto text-gray-700 mb-8">
          Our professional electricians are ready to handle wiring, repairs, and installations. Whether you’re facing power
          issues or planning electrical upgrades, we ensure safe, reliable service.
        </p>
